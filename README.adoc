...
+
ie: When a new FHIR _Patient_ resource is posted to the HAPI FHIR server, a record is added to the PostgreSQL database of the HAPI FHIR server and a change event is sent to a AMQ Streams/Kafka topic.
